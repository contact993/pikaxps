...
Corepeak이 연구에 도움이 됐다면 인용해 주세요 — 무료 학술 도구가 지속 개발을 정당화하는 방법입니다.

DOI가 있는 동료심사 소프트웨어 논문을 준비 중입니다. 그 전까지는 저장소와 사용한 릴리스 버전을
인용해 주세요:
...
저장소에 [`CITATION.cff`](https://github.com/contact993/xpsfit/blob/main/CITATION.cff)가 있어서
