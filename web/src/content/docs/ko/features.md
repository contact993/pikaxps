---
title: 기능
description: 백그라운드, 라인섀입, doublet/satellite, fit auditor, 출처 명시 레퍼런스 DB, 정량, 배치 피팅, 유연한 임포트 — Corepeak의 모든 기능.
---
...
**leave-one-out 필요성 검정(BIC)**. [작동 원리 →](/corepeak/ko/guides/fit-audit/)
...
레퍼런스를 추가하면 로컬에 저장되고 업데이트해도 유지되며, [공유 DB에 제보](/corepeak/ko/contribute/)할
수도 있습니다.
